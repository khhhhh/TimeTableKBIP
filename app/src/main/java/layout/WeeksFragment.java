 ...
 * {@link WeeksFragment.OnFragmentInteractionListener} interface
...
public class WeeksFragment extends Fragment {
     ...
     * @return A new instance of fragment WeeksFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WeeksFragment newInstance(String param1, String param2) {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
         ...
         //             + " must implement OnFragmentInteractionListener");
            Toast.makeText(context,"Weeks",Toast.LENGTH_SHORT).show();
